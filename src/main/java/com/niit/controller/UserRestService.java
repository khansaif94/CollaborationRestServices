...
public class UserRestService {
	...
	public String storeFile(@PathVariable("id") String id, @RequestParam("file") MultipartFile[] files,
			  ...
			  System.out.println(request.getRealPath("/").substring(0, 90));
			  String path = request.getRealPath("/").substring(0,90) + "CollaborationFrontEnd\\resources\\images\\" + files[0].getOriginalFilename();
